...
const ItemsList = ({
  ...
  const { CategoryShop } = match.params;
  ...
  const itemsListByCategoryShop_logic = 
    ...
    <Col md={{ size: 9, order: 1 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center'}}>
        ...
        <ButtonLinkCategoryShopPage CategoryShop='foods'/>
        <ButtonLinkCategoryShopPage CategoryShop='cosmetics'/>
      </div>}
  ...
  return (
    <div>
      ...
      <Container style={styles.containerPaddingTop}>
        <Row>
          {itemsListByCategoryShop_logic} {/* show list depending on CategoryShop  */}
          {sideBar}
        </Row>
      </Container>
    </div>
