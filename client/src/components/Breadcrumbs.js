...
const Breadcrumbs = ({
  ...
  const CategoryShopLink = CategoryShop && <Fragment><Link style={styles.linkColor} to={`/category/${CategoryShop}`}>{` ${CategoryShop && CategoryShop.charAt(0).toUpperCase() + CategoryShop.substr(1)}'s Apparels`}</Link> ></Fragment>; 
