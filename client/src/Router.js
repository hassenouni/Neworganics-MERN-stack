...
const ItemsListCategoryShopHomepage = Loadable({
  loader: () => import('./components/Items-list-CategoryShop-homepage'),
  loading: Loading
});
  ...
  <div>
    <NavbarContainer />
      <Switch>
        ...
        <Route exact path='/productslist/:CategoryShop' component={ItemsListContainer} />
        <Route exact path='/category/:CategoryShop' component={ItemsListCategoryShopHomepage} />
